...
```{r ans11}
logic<-finStatement[[16]]<0
loss1Companies<- finStatement$公司名稱[logic]
loss1Companies
```
...
```{r ans12}
logic1<-finStatement[[33]]<0
loss2Companies<- finStatement$公司名稱[logic1]
loss2Companies
```
...
```{r ans13}
logic2<-(finStatement[[16]]>0) & (finStatement[[33]]<0)
logic3<-(finStatement[[16]]<0) & (finStatement[[33]]>0)
only1LossCompanies<- finStatement$公司名稱[logic2 | logic3]
only1LossCompanies
```
...
df_oneShow <- data.frame(
      title = c(exhibitionList[[1]][[3]]),
      time =c(exhibitionList[[1]][[5]][[1]][[1]]),
      location =c(exhibitionList[[1]][[5]][[1]][[2]]),
      locationName =c(exhibitionList[[1]][[5]][[1]][[3]]),
      price =c(exhibitionList[[1]][[5]][[1]][[5]]),
      endTime =c(exhibitionList[[1]][[5]][[1]][[8]]),
      sourceWebName =c(exhibitionList[[1]][[18]]),
      stringsAsFactors = F
) 
df_oneShow
```
...
dataframe_show_info <- function(exhibitionInput){
df_oneShow <- data.frame(
      title = c(exhibitionInput[[3]]),
      time =c(exhibitionInput[[5]][[1]][[1]]),
      location =c(exhibitionInput[[5]][[1]][[2]]),
      locationName =c(exhibitionInput[[5]][[1]][[3]]),
      price =c(exhibitionInput[[5]][[1]][[5]]),
      endTime =c(exhibitionInput[[5]][[1]][[8]]),
      sourceWebName =c(exhibitionInput[[18]]),
...
```{r ans24}
factor(df_allShows$sourceWebName) -> df_allShows$sourceWebName
